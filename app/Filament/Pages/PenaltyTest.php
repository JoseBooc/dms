...
class PenaltyTest extends Page implements HasForms
{
    use InteractsWithForms;

    protected static ?string $navigationIcon = 'heroicon-o-exclamation';
    protected static string $view = 'filament.pages.penalty-test';
    protected static ?string $title = 'Penalty Test';
    protected static ?string $navigationLabel = 'Penalty Test';
