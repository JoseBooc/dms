...
use App\Filament\Resources\TestBillResource\Pages;
use App\Models\Bill;
use App\Models\User;
use App\Models\Room;
use Filament\Forms;
...
class TestBillResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListTestBills::route('/'),
            'create' => Pages\CreateTestBill::route('/create'),
            'edit' => Pages\EditTestBill::route('/{record}/edit'),
        ];
    }
}